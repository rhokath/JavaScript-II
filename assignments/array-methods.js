...
// Problem 1
//The group would like to know who the top donors were in the race so they can get a special goody bag at the end of the race. Provide them with all participants who donated more than $250.
const topDonors = runners.filter(function(donationSize){
    if (donationSize.donation > 250){
        return true;
    }
})
console.log(topDonors);
const namesTopDonors = topDonors.map(function(name){
    return name.first_name;
})
console.log(namesTopDonors);
// Problem 2
//The group would like the information orginized in a different way. Please alphebetize by last name!
const sortedRunners = runners.sort(function(a,b){
...
// Problem 3
//The group just wants a list of companies. Oh yeah alphebetized please!
let companyNames = []
runners.forEach(function(company){
    return companyNames.push(company.company_name)
})
